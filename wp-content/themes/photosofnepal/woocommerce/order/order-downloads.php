                ...
                <td class="product-thumbnail">
                    <a href="<?= esc_url( $download['product_url'] ) ?>">
                        <img src="<?= wp_get_attachment_image_url( $product->get_image_id(), 'photography_thumbnail' ) ?>"
                             alt="" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" width="120">
                    </a>
                </td>
						...
						if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								case 'download-product':
									...
									break;
								case 'download-file':
									echo '<a href="' . esc_url( $download['download_url'] ) . '" class="woocommerce-MyAccount-downloads-file button alt d-block text-center"><icon class="icon-download mr-3"></icon>' . 'Download' . '</a>';
									break;
