        ...
        <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-center">
                <div class="profile__info text-center">
                    <h1 class="profile__info-name"><?= $author->display_name ?></h1>
                    <p><?php the_author_posts(); ?> Photos </p>
                </div>
            </div>
        </div>
    </section>
                                    ...
                                    <div class="card card-hover border-0 mb-3">
                                        <div class="card-image">
                                            <a href="<?php the_permalink(); ?>">
                                                <img src="<?= wp_get_attachment_image_url( $cover_image_id, 'profile_gallery' ) ?>"
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <!--                        <p class="mb-5">--><? //= um_user( 'description' ) ?><!--</p>-->
